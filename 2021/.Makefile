...
.PHONY: day15
day15:
	$(CC) $(CFLAGS) -DPARTONE -o build/$@.1.out ./src/day15/main.c lib/aoclib.c
	$(CC) $(CFLAGS) -DPARTTWO -o build/$@.2.out ./src/day15/main.c lib/aoclib.c

.PHONY: day16
day16:
	$(CC) $(CFLAGS) -DPARTONE -o build/$@.1.out ./src/day16/main.c lib/aoclib.c
	$(CC) $(CFLAGS) -DPARTTWO -o build/$@.2.out ./src/day16/main.c lib/aoclib.c

.PHONY: day17
day17:
	$(CC) $(CFLAGS) -DPARTONE -o build/$@.1.out ./src/day17/main.c lib/aoclib.c
	$(CC) $(CFLAGS) -DPARTTWO -o build/$@.2.out ./src/day17/main.c lib/aoclib.c
...
.PHONY: day20
day20:
	$(CC) $(CFLAGS) -DPARTONE -o build/$@.1.out ./src/day20/main.c lib/aoclib.c
	$(CC) $(CFLAGS) -DPARTTWO -o build/$@.2.out ./src/day20/main.c lib/aoclib.c
